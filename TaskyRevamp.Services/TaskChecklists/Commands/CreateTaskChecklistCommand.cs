...
public class CreateTaskChecklistHandler : IRequestHandler<CreateTaskChecklistCommand, Guid>
{
    ...
    public CreateTaskChecklistHandler(IRepository<TaskChecklist> taskChecklistRepository) =>
    ...
    {
        var taskChecklist = new TaskChecklist(request.TaskChecklistDto.TaskId,
            request.TaskChecklistDto.TitleEnglish, request.TaskChecklistDto.TitleArabic);
