        ...
        public void Seed(EfDbContext context)
        {
            ...
            TemplateEnglish="<p style=\"color: rgb(0, 0, 0); font-family: &quot;Segoe UI VSS (Regular)&quot;, &quot;Segoe UI&quot;, -apple-system, BlinkMacSystemFont, Roboto, &quot;Helvetica Neue&quot;, Helvetica, Ubuntu, Arial, sans-serif, &quot;Apple Color Emoji&quot;, &quot;Segoe UI Emoji&quot;, &quot;Segoe UI Symbol&quot;; font-size: 14px; font-style: normal; font-weight: 400; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; background-color: rgb(255, 255, 255);\">Dear [RecipientName],<br><br>The task [TaskName] has been updated.</p><p style=\"color: rgb(0, 0, 0); font-family: &quot;Segoe UI VSS (Regular)&quot;, &quot;Segoe UI&quot;, -apple-system, BlinkMacSystemFont, Roboto, &quot;Helvetica Neue&quot;, Helvetica, Ubuntu, Arial, sans-serif, &quot;Apple Color Emoji&quot;, &quot;Segoe UI Emoji&quot;, &quot;Segoe UI Symbol&quot;; font-size: 14px; font-style: normal; font-weight: 400; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; background-color: rgb(255, 255, 255);\">Regards,</p>",
               ...
               new NotificationTypeTemplate{
                   ...
                   SubjectArabic="قام [اسم المنشئ] بإنشاء المهمة",
                   SubjectEnglish="[User Name] created the task",
                   TemplateArabic="",
                   TemplateEnglish="",
               },
               new NotificationTypeTemplate{
                ...
                moduleType= Dto.Enums.ModuleType.History,
                   SubjectArabic="[قام [اسم المستخدم] بتحديث تقدم المهمة إلى [نسبة التقدم الجديدة",
                   SubjectEnglish="[User Name] updated the task progress to [New Progress %]",
                   TemplateArabic="",
                   TemplateEnglish="",
               },
               new NotificationTypeTemplate{
                   ...
                   NameArabic = "ارجاع المهمة",
               moduleType= Dto.Enums.ModuleType.History,
                   SubjectArabic="قام [اسم المستخدم] بإرجاع المهمة, بسبب: [سبب الإرجاع]",
                   SubjectEnglish="[User Name] returned the task with the reason: [Return Reason]",
                   TemplateArabic="",
                   TemplateEnglish="",
               },
               new NotificationTypeTemplate{
            ...
            moduleType= Dto.Enums.ModuleType.History,
                   SubjectArabic="قام [اسم المستخدم] بإكمال المهمة",
                   SubjectEnglish="[User Name] marked the task as completed",
                   TemplateArabic="",
                   TemplateEnglish="",
               },
               ...
               new NotificationTypeTemplate{
                ...
                moduleType= Dto.Enums.ModuleType.History,
                   SubjectArabic="لقد تأخرت المهمة",
                   SubjectEnglish="The task due date is overdue",
                   TemplateArabic="",
                   TemplateEnglish="",
               },
               new NotificationTypeTemplate{
               ...
               moduleType= Dto.Enums.ModuleType.History,
               SubjectArabic="قام [اسم المستخدم] بنقل المهمة على أنها جاهزة للمراجعة",
               SubjectEnglish="[User Name] marked the task as ready for review",
               TemplateArabic="",
               TemplateEnglish=""
               },
               new NotificationTypeTemplate{
               ...
               moduleType= Dto.Enums.ModuleType.History,
               SubjectArabic="قام [اسم المستخدم] بإضافة مرفق [اسم المرفق]",
               SubjectEnglish="[User Name] added an attachment [Attachment Name]",
               TemplateArabic="",
               TemplateEnglish=""
               ...
               new NotificationTypeTemplate{
                   ...
                   NameArabic = "حذف ملف",
               moduleType= Dto.Enums.ModuleType.History,
               SubjectArabic="قام [اسم المستخدم] بحذف مرفق [اسم المرفق]",
               SubjectEnglish="[User Name] deleted an attachment [Attachment Name]",
               TemplateArabic="",
               TemplateEnglish=""
               ...
               new NotificationTypeTemplate{
                  ...
                  moduleType= Dto.Enums.ModuleType.History,
                   SubjectArabic="طلب [اسم المستخدم] تغيير تاريخ انتهاء المهمة من [التاريخ القديم] إلى [التاريخ الجديد]. مع السبب: [السبب]",
                   SubjectEnglish="[User Name] requested to change the task end date from [Old Date] to [New Date], with reason: [Reason]",
                   TemplateArabic="",
                   TemplateEnglish="",
               },
               new NotificationTypeTemplate{
                 ...
                 IsEnable=true,
                  ...
                  moduleType= Dto.Enums.ModuleType.History,
                   SubjectArabic="[اسم المستخدم] [حالة الإجراء (تمت الموافقه أو تم رفضه)] تاريخ انتهاء المهمة من [التاريخ القديم] إلى [التاريخ الجديد]",
                   SubjectEnglish="[User Name] [Action Status (Approved or Rejected)] the task end date from [Old Date] to [New Date]",
                   TemplateArabic="",
                   TemplateEnglish="",
               },
                  new NotificationTypeTemplate{
                   ...
                   NameArabic = "تقرير اسبوعى",
                   moduleType= Dto.Enums.ModuleType.History,
                   SubjectArabic="أرسل [اسم المستخدم] طلب دعم إلى [الاسم المدعوم]",
                   SubjectEnglish="[User Name] sent a support request to [Supported Name]",
                   TemplateArabic="",
                   TemplateEnglish="",
               },
               new NotificationTypeTemplate{
                ...
                moduleType= Dto.Enums.ModuleType.History,
                   SubjectArabic="قام [اسم المستخدم] بتعديل المهمة",
                   SubjectEnglish="[User Name] edited the task",
                   TemplateArabic="",
                   TemplateEnglish="",
               },
               new NotificationTypeTemplate{
                   ...
                   NameArabic = "رفض المهمه",
                    moduleType= Dto.Enums.ModuleType.History,
                   SubjectArabic="قام [اسم المستخدم] برفض المهمة، مع السبب: [سبب الرفض]",
                   SubjectEnglish="[User Name] rejected the task, with reason: [Rejection Reason]",
                   TemplateArabic="",
                   TemplateEnglish="",
               },
                new NotificationTypeTemplate{
                   ...
                   NameArabic = "تغيير اولويه المهمه",
                   moduleType= Dto.Enums.ModuleType.History,
                   SubjectArabic="قام [اسم المستخدم] بتغيير الأولوية من [الأولوية القديمة] إلى [الأولوية الجديدة]",
                   SubjectEnglish="[User Name] changed the priority from [Old Priority] to [New Priority]",
                   TemplateArabic="",
                   TemplateEnglish="",
                },
                 new NotificationTypeTemplate{
                   ...
                   moduleType= Dto.Enums.ModuleType.History,
                   SubjectArabic="قام [اسم المستخدم] بتحديث وصف المهمة",
                   SubjectEnglish="[User Name] updated the task description",
                   TemplateArabic="",
                   TemplateEnglish="",
                 },
                   new NotificationTypeTemplate{
                   ...
                   moduleType= Dto.Enums.ModuleType.History,
                   SubjectArabic="قام [اسم المستخدم] بإضافة قائمة تحقق [عنصر قائمة تحقق]",
                   SubjectEnglish="[User Name] added a checklist [Checklist Item]",
                   TemplateArabic="",
                   TemplateEnglish="",
                   },
                   new NotificationTypeTemplate{
                   ...
                   moduleType= Dto.Enums.ModuleType.History,
                   SubjectArabic="قام [اسم المستخدم] بإزالة قائمة التحقق [عنصر قائمة مراجعة]",
                   SubjectEnglish="[User Name] removed a checklist [Checklist Item]",
                   TemplateArabic="",
                   TemplateEnglish="",
                   },
                    new NotificationTypeTemplate{
                   ...
                   moduleType= Dto.Enums.ModuleType.History,
                   SubjectArabic="قام [اسم المستخدم] بتعديل عنصر قائمة مراجعة [عنصر قائمة مراجعة]",
                   SubjectEnglish="[User Name] Updated a checklist item [Checklist Item]",
                   TemplateArabic="",
                   TemplateEnglish="",
                    },
               new NotificationTypeTemplate{
                ...
                moduleType= Dto.Enums.ModuleType.History,
                   SubjectArabic="تم تصعيد المهمة إلى [استُبعدت إلى المستخدم]، مع السبب: [سبب التصعيد]",
                   SubjectEnglish="The task is escalated to [Exclated To User], with reason: [Escalation Reason]",
                   TemplateArabic="",
                   TemplateEnglish="",
               },
                              new NotificationTypeTemplate{
                ...
                moduleType= Dto.Enums.ModuleType.History,
                   SubjectArabic="قام [اسم المستخدم] بإضافة تعليق",
                   SubjectEnglish="[User Name] added a comment",
                   TemplateArabic="",
                   TemplateEnglish="",
               },
                 new NotificationTypeTemplate{
                ...
                moduleType= Dto.Enums.ModuleType.History,
                   SubjectArabic="قام [اسم المستخدم] بحذف تعليق",
                   SubjectEnglish="[User Name] deleted a comment",
                   TemplateArabic="",
                   TemplateEnglish="",
               },
                new NotificationTypeTemplate{
                   ...
                   NameArabic = "حذف مهمة",
                moduleType= Dto.Enums.ModuleType.History,
                   SubjectArabic="قام [اسم المستخدم] بحذف المهمة",
                   SubjectEnglish="[User Name] deleted the task",
                   TemplateArabic="",
                   TemplateEnglish="",
               },
               new NotificationTypeTemplate{
                   ...
                   moduleType= Dto.Enums.ModuleType.History,
                   SubjectArabic="قام [اسم المستخدم] بإستعاد المهمة المحذوفة",
                   SubjectEnglish="[User Name] restored the deleted task",
                   TemplateArabic="",
                   TemplateEnglish="",
               },
                              new NotificationTypeTemplate{
                   ...
                   moduleType= Dto.Enums.ModuleType.History,
                   SubjectArabic="قام [اسم المستخدم] بذكر [اسم المستخدم المذكور]في التعليق",
                   SubjectEnglish="[User Name] mentioned [Mentioned User Name] in the comment.",
                   TemplateArabic="",
                   TemplateEnglish="",
               },
                new NotificationTypeTemplate{
               ...
               new NotificationTypeTemplate{
                   ...
                   NameArabic = "حذف جدوله",
                    moduleType= Dto.Enums.ModuleType.History,
                    SubjectArabic="@Action_owner قام بحذف التصعيد الذي تم إرساله لهذه المهمة @Task_Name",
                   SubjectEnglish="@Action_owner deleted the raised escalation that was sent for task @Task_Name\r\n",
                   TemplateArabic="",
                   TemplateEnglish="",
               },
               new NotificationTypeTemplate{
